...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40">
      {/* Background layer — clips glow but NOT the FAB */}
      <div className="absolute inset-0 bg-card/95 backdrop-blur-md border-t border-border overflow-hidden">
      ...
      <div className="relative max-w-lg mx-auto px-2 pt-3 pb-2 safe-bottom">
        ...
        {/* Center Log FAB — sits above the bg layer */}
        <Link
          to="/log"
          className="absolute left-1/2 -translate-x-1/2 -top-4 z-50 flex flex-col items-center"
        >
          <motion.div
            whileTap={{ scale: 0.95 }}
            className="gradient-primary w-14 h-14 rounded-full flex items-center justify-center shadow-[0_0_22px_rgba(111,175,159,0.35)]"
          >
