...
-- Privacy-safe community aggregation function
-- Only aggregates sessions from users who have opted in (community_sharing_enabled = true)
-- and only for sessions linked to canonical strains.
...
BEGIN
  ...
  SELECT
    ...
    sl.intent,
    -- Top 3 effects by average score
    (
